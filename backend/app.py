...
# Konfigurasi database (lebih rapi)
DB_CONFIG = {
    "host": "localhost",
...
def get_transactions():
    ...
    try:
        ...
        print("DEBUG rows:", rows)  # <-- ini sekarang bakal dict per row

        cur.close()
        conn.close()

        return jsonify(rows)  # langsung kirim dict
    except Exception as e:
...
if __name__ == "__main__":
    print("Memulai server Flask pada port 5000")
